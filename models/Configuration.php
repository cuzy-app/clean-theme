...
class Configuration extends Model
{
    ...
    {
        $css = '/** This file is auto-generated by the Clean Theme configuration. Do not edit the file directly. */' . PHP_EOL . PHP_EOL . ':root {' . PHP_EOL;
        ...
        foreach ($this->getSpecialColorCssVariables() as $cssVariable) {
            ...
            if ($colorName && $amount && in_array($function, static::SUPPORTED_LESS_FUNCTIONS, true)) {
